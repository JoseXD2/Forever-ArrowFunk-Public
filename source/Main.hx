	...
	**/
	public static var gameWeeks:Array<Dynamic> = [
		[
			['Tutorial'],
			['kevin'],
			[FlxColor.fromRGB(255, 190, 40)],
			'Kevin'
		],
		[
			['Reboop', 'Fresher', 'Rap-King'],
			['sagu', 'sagu', 'sagu-fire'],
			[FlxColor.fromRGB(136, 93, 200), FlxColor.fromRGB(136, 93, 200), FlxColor.fromRGB(176, 93, 155)],
			'Grape Sago'
		],
		[
			['Bittersweet', 'Nightfall', 'Virus'],
			['kids', 'kids-happy', 'kids-virus'],
			[FlxColor.fromRGB(194, 111, 135), FlxColor.fromRGB(74, 91, 228), FlxColor.fromRGB(34, 71, 68)],
			'Spooky Party!!1'
		],
		[
			['Shacklesz', 'Blam', 'Loaded'],
			['dono', 'dono', 'donoangry'],
			[FlxColor.fromRGB(108, 40, 80), FlxColor.fromRGB(88, 20, 80), FlxColor.fromRGB(68, 20, 80)],
			'Favela Owner'
		],
	];
